 ...
 */
fun <LocalState, GlobalState, LocalAction, GlobalAction> Reducer<LocalState, LocalAction>.pullback(
        mapToLocalState: (GlobalState) -> LocalState,
        mapToLocalAction: (GlobalAction) -> LocalAction?,
        mapToGlobalState: (GlobalState, LocalState) -> GlobalState,
        mapToGlobalAction: (LocalAction) -> GlobalAction,
    ): Reducer<GlobalState, GlobalAction> = PullbackReducer(
    this, mapToLocalState, mapToLocalAction, mapToGlobalState, mapToGlobalAction)
 ...
 * @see pullback
 */
fun <LocalState, GlobalState, LocalAction, GlobalAction> Reducer<LocalState, LocalAction>.optionalPullback(
        mapToLocalState: (GlobalState) -> LocalState?,
        mapToLocalAction: (GlobalAction) -> LocalAction?,
        mapToGlobalState: (GlobalState, LocalState?) -> GlobalState,
        mapToGlobalAction: (LocalAction) -> GlobalAction,
    ): Reducer<GlobalState, GlobalAction> = OptionalReducer(
    this, mapToLocalState, mapToLocalAction, mapToGlobalState, mapToGlobalAction)
 ...
 * @see forEach
 */
fun <ParentState, ElementState, ParentAction, ElementAction, ID> Reducer<ParentState, ParentAction>.forEachMap(
    ...
    ): Reducer<ParentState, ParentAction> = ForEachReducer(
        parentReducer = this,
 ...
 * @see forEach
 */
fun <ParentState, ElementState, ParentAction, ElementAction> Reducer<ParentState, ParentAction>.forEachList(
        elementReducer: Reducer<ElementState, ElementAction>,
        ...
        elementReducer = elementReducer,
        mapToElementAction = mapToElementAction,
        mapToElementState = { state, index ->
            mapToElementList(state)[index] ?: throw NoSuchElementException("Element with index=$index not found")
        },
        mapToParentAction = mapToParentAction,
 ...
 */
fun <ParentState, ElementState, ParentAction, ElementAction, ID> Reducer<ParentState, ParentAction>.forEach(
        elementReducer: Reducer<ElementState, ElementAction>,
        mapToElementAction: (ParentAction) -> Pair<ID, ElementAction>?,
